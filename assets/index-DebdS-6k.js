...
const CHANNEL_CONFIG = {
  // Your channel name displayed throughout the site
  channelName: "Vinay Tech Zone",
  // Your channel tagline shown in the hero section
  tagline: "Inspiring content, every week. Subscribe and join the journey.",
  // Your YouTube channel URL
  youtubeChannelUrl: "https://youtube.com/@vinay_tech_zone",
  // Short bio for the About section
  bio: `Welcome! I'm a passionate content creator dedicated to bringing you high-quality videos on topics that matter. From tutorials and deep dives to vlogs and reviews — there's something here for everyone. Join our growing community and let's explore together!`,
  // Channel statistics shown in the About section
  stats: [
    { label: "Videos", value: "100+" },
    { label: "Subscribers", value: "1500+" },
    { label: "Views", value: "700K+" },
    { label: "Years Active", value: "1+" }
  ],
  // Social media links
  socialLinks: {
    linkedin: "https://www.linkedin.com/in/vinay-thallapalli-2b8313377/",
    instagram: "https://www.instagram.com/vinay_thallapalli_/?hl=en",
    github: "https://github.com/vinaytechvisions"
  }
};
const VIDEOS_CONFIG = [
  { id: "4IJxnxTMLeE", title: "Getting Started: Everything You Need to Know" },
  { id: "YlDRAoJT_Yo", title: "My First Video Ever — A Look Back" },
  { id: "jBS1Tg6kq9Q", title: "Top 10 Tips for Beginners in 2024" },
  { id: "j5Jtv8s1kBk", title: "Behind the Scenes: How I Make My Videos" }
];
const NAV_LINKS$1 = [
...
function Navigation() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 nav-blur ${isScrolled ? "bg-dark-primary/90 border-b border-dark-border shadow-lg" : "bg-transparent"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-yt-red rounded-sm flex items-center justify-center group-hover:bg-yt-red-hover transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "w-5 h-5 text-white", strokeWidth: 2.5 }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading font-bold text-lg text-foreground tracking-tight hidden sm:block", children: CHANNEL_CONFIG.channelName })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex items-center gap-1", children: NAV_LINKS$1.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => handleNavClick(link.href),
              className: "px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-dark-tertiary rounded-md transition-all duration-200",
              children: link.label
            }
          ) }, link.href)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: CHANNEL_CONFIG.youtubeChannelUrl,
              target: "_blank",
              rel: "noopener noreferrer",
              className: "hidden md:flex items-center gap-2 bg-yt-red hover:bg-yt-red-hover text-white font-semibold text-sm px-4 py-2 rounded-sm transition-all duration-200 hover:shadow-red-glow",
              children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: "md:hidden p-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-dark-tertiary transition-colors",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-3 border-t border-dark-border space-y-1", children: [
              NAV_LINKS$1.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => handleNavClick(link.href),
                  className: "w-full text-left px-4 py-3 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-dark-tertiary rounded-md transition-colors",
                  children: link.label
                },
                link.href
              )),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-2 px-4 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: CHANNEL_CONFIG.youtubeChannelUrl,
                  target: "_blank",
                  rel: "noopener noreferrer",
                  className: "flex items-center justify-center gap-2 w-full bg-yt-red hover:bg-yt-red-hover text-white font-semibold text-sm px-4 py-3 rounded-sm transition-colors",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: { backgroundImage: "url('/assets/generated/channel-banner.dim_1280x360.png')" },
            "aria-hidden": "true"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(to bottom, oklch(0.1 0 0 / 70%) 0%, oklch(0.1 0 0 / 85%) 60%, oklch(0.1 0 0) 100%)"
            },
            "aria-hidden": "true"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute inset-0",
            style: {
              background: "radial-gradient(ellipse at center, oklch(0.55 0.22 27 / 15%) 0%, transparent 70%)"
            },
            "aria-hidden": "true"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-yt-red/20 border border-yt-red/40 text-yt-red text-xs font-semibold px-3 py-1.5 rounded-full mb-6 animate-fade-in", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 bg-yt-red rounded-full animate-pulse" }),
            "YouTube Channel"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-heading font-black text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-foreground leading-none tracking-tight mb-4 animate-fade-in-up", children: CHANNEL_CONFIG.channelName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up", style: { animationDelay: "0.1s" }, children: CHANNEL_CONFIG.tagline }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up", style: { animationDelay: "0.2s" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: CHANNEL_CONFIG.youtubeChannelUrl,
                target: "_blank",
                rel: "noopener noreferrer",
                className: "flex items-center gap-3 bg-yt-red hover:bg-yt-red-hover text-white font-bold text-base px-8 py-4 rounded-sm transition-all duration-200 hover:shadow-red-glow hover:scale-105 w-full sm:w-auto justify-center",
                children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: "flex items-center gap-3 bg-dark-secondary hover:bg-dark-tertiary border border-dark-border text-foreground font-semibold text-base px-8 py-4 rounded-sm transition-all duration-200 hover:border-yt-red/50 w-full sm:w-auto justify-center",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-5 h-5 text-yt-red" }),
                  "Watch Videos"
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-8 mt-14 animate-fade-in-up", style: { animationDelay: "0.3s" }, children: CHANNEL_CONFIG.stats.slice(0, 3).map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading font-bold text-2xl sm:text-3xl text-foreground", children: stat.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground uppercase tracking-widest mt-0.5", children: stat.label })
          ] }, stat.label)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
...
function VideoCard({ id, title, index: index2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
      className: "group bg-dark-secondary border border-dark-border rounded-lg overflow-hidden card-hover",
      style: { animationDelay: `${index2 * 0.08}s` },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full", style: { paddingBottom: "56.25%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "iframe",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 flex-shrink-0 w-7 h-7 bg-yt-red/15 rounded-sm flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-3.5 h-3.5 text-yt-red fill-yt-red" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading font-semibold text-sm text-foreground leading-snug line-clamp-2 group-hover:text-yt-red transition-colors", children: title })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              target: "_blank",
              rel: "noopener noreferrer",
              className: "flex-shrink-0 p-1.5 text-muted-foreground hover:text-foreground transition-colors rounded",
...
function VideosSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "videos", className: "py-20 sm:py-28 bg-dark-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-yt-red text-xs font-bold uppercase tracking-[0.2em] mb-3", children: "Latest Content" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading font-black text-4xl sm:text-5xl text-foreground mb-4", children: "Featured Videos" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "Watch our most popular and recent uploads. New content drops every week." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider w-24 mx-auto mt-6" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: VIDEOS_CONFIG.map((video, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(VideoCard, { id: video.id, title: video.title, index: index2 }, video.id)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        ...
        target: "_blank",
        rel: "noopener noreferrer",
        className: "inline-flex items-center gap-2 border border-dark-border hover:border-yt-red/60 text-muted-foreground hover:text-foreground font-semibold text-sm px-6 py-3 rounded-sm transition-all duration-200 hover:bg-dark-secondary",
        children: [
...
const STAT_ICONS = [Video, Users, Eye, Calendar];
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 sm:py-28 bg-dark-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-yt-red text-xs font-bold uppercase tracking-[0.2em] mb-3", children: "About Me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading font-black text-4xl sm:text-5xl text-foreground mb-4", children: "Meet the Creator" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider w-24 mx-auto mt-6" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row items-center gap-12 lg:gap-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-64 h-64 sm:w-80 sm:h-80", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border-2 border-yt-red/30 scale-110" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border border-yt-red/15 scale-125" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: "/assets/generated/profile-avatar.dim_400x400.png",
            alt: "Channel creator profile",
            className: "w-full h-full object-cover rounded-full border-4 border-dark-border relative z-10"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 right-4 z-20 w-10 h-10 bg-yt-red rounded-full flex items-center justify-center shadow-red-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "w-5 h-5 text-white" }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-center lg:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading font-bold text-3xl sm:text-4xl text-foreground mb-2", children: CHANNEL_CONFIG.channelName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-yt-red font-semibold text-sm uppercase tracking-widest mb-6", children: "Content Creator" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base sm:text-lg leading-relaxed mb-8 max-w-2xl", children: CHANNEL_CONFIG.bio }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8", children: CHANNEL_CONFIG.stats.map((stat, index2) => {
          const Icon2 = STAT_ICONS[index2 % STAT_ICONS.length];
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "bg-dark-primary border border-dark-border rounded-lg p-4 text-center hover:border-yt-red/40 transition-colors",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-yt-red mx-auto mb-2" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading font-bold text-xl text-foreground", children: stat.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground uppercase tracking-wider mt-0.5", children: stat.label })
              ]
            },
            stat.label
          );
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            target: "_blank",
            rel: "noopener noreferrer",
            className: "inline-flex items-center gap-3 bg-yt-red hover:bg-yt-red-hover text-white font-bold text-base px-8 py-4 rounded-sm transition-all duration-200 hover:shadow-red-glow hover:scale-105",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "w-5 h-5" }),
...
const GOOGLE_FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLScveqD2blkWCr4HK2qSMAhQOQ4ZxHpEM-XSfuMeDINP31tyNQ/viewform?embedded=true";
function ContactSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 sm:py-28 bg-dark-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-yt-red text-xs font-bold uppercase tracking-[0.2em] mb-3", children: "Get in Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading font-black text-4xl sm:text-5xl text-foreground mb-4", children: "Contact Me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "Have a question, collaboration idea, or just want to say hi? Fill out the form below!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider w-24 mx-auto mt-6" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto bg-dark-secondary border border-dark-border rounded-lg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "iframe",
      {
        src: GOOGLE_FORM_URL,
        width: "100%",
...
function Footer() {
  ...
  const appId = encodeURIComponent(typeof window !== "undefined" ? window.location.hostname : "youtube-channel-site");
  const handleNavClick = (href) => {
    const target = document.querySelector(href);
    if (target) target.scrollIntoView({ behavior: "smooth" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-dark-secondary border-t border-dark-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-yt-red rounded-sm flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "w-5 h-5 text-white", strokeWidth: 2.5 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading font-bold text-lg text-foreground", children: CHANNEL_CONFIG.channelName })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-5 max-w-xs", children: CHANNEL_CONFIG.tagline }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: CHANNEL_CONFIG.youtubeChannelUrl,
            target: "_blank",
            rel: "noopener noreferrer",
            className: "inline-flex items-center gap-2 bg-yt-red hover:bg-yt-red-hover text-white font-semibold text-sm px-4 py-2.5 rounded-sm transition-all duration-200 hover:shadow-red-glow",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "w-4 h-4" }),
              "Subscribe"
            ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-heading font-semibold text-sm text-foreground uppercase tracking-widest mb-4", children: "Navigation" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => handleNavClick(link.href),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-heading font-semibold text-sm text-foreground uppercase tracking-widest mb-4", children: "Follow Along" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              target: "_blank",
              rel: "noopener noreferrer",
              className: "w-9 h-9 bg-dark-primary border border-dark-border rounded-sm flex items-center justify-center text-muted-foreground hover:text-yt-red hover:border-yt-red/50 transition-all duration-200",
              "aria-label": "YouTube",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: CHANNEL_CONFIG.socialLinks.linkedin,
              target: "_blank",
              rel: "noopener noreferrer",
              className: "w-9 h-9 bg-dark-primary border border-dark-border rounded-sm flex items-center justify-center text-muted-foreground hover:text-[#0A66C2] hover:border-[#0A66C2]/50 transition-all duration-200",
              "aria-label": "LinkedIn",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiLinkedin, { className: "w-4 h-4" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: CHANNEL_CONFIG.socialLinks.instagram,
              target: "_blank",
              rel: "noopener noreferrer",
              className: "w-9 h-9 bg-dark-primary border border-dark-border rounded-sm flex items-center justify-center text-muted-foreground hover:text-[#E1306C] hover:border-[#E1306C]/50 transition-all duration-200",
              "aria-label": "Instagram",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiInstagram, { className: "w-4 h-4" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: CHANNEL_CONFIG.socialLinks.github,
              target: "_blank",
              rel: "noopener noreferrer",
              className: "w-9 h-9 bg-dark-primary border border-dark-border rounded-sm flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-dark-border/80 transition-all duration-200",
              "aria-label": "GitHub",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider mb-6" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        ...
        currentYear,
        " ",
        CHANNEL_CONFIG.channelName,
        ". All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-1", children: [
        "Built with",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-3 h-3 text-yt-red fill-yt-red mx-0.5" }),
        " ",
        "using",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-dark-primary", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(VideosSection, {}),
